...
public static class UnhandledExceptionHandler
{
    ...
    public static void HandleException(Exception ex)
    {
        ...
        var dateString = DateTime.UtcNow.ToString("yyyyMMdd_Hmmss");

        File.WriteAllText($"logs/{dateString}.txt", "A shit, it looks like you did something that the osu!player did not like. If you think this is a bug, please report this crashlog to Founntain via the following methods:"
                                                    + Environment.NewLine
                                                    ...
                                                    + Environment.NewLine + "Discord: https://discord.gg/RJQSc5B"
                                                    + Environment.NewLine + "Email: 7@founntain.dev"
                                                    + Environment.NewLine
                                                    + Environment.NewLine
